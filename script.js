...
function playGame(){
  ...
  console.log("Guessed number",numberGuess);
  console.log("Corerct number",correctNumber);
  displayResult(numberGuess);
}

function displayResult(numberGuess){
  if(numberGuess > correctNumber){
    //console.log("Too hogh");
    showNumberAbove();
...
function getRandomNumber(){
  ...
  //console.log("corerct number is",correctNumber);
}
